...
class PunchCorrectionApprovalActivity : MotionBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) { 
        ...
        setContentView(R.layout.activity_punch_correction_approval)
        
        applyWindowInsets(findViewById(R.id.clPunchCorrectionApprovalRoot), findViewById(R.id.appBar))
        
        list=findViewById(R.id.llPunchApprovalList); empty=findViewById(R.id.tvPunchApprovalEmpty); findViewById<View>(R.id.btnRefreshPunchApproval).setOnClickListener{load()}; findViewById<View>(R.id.toolbar).setOnClickListener{finish()}; load() 
    }
