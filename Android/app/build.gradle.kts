...
// Android talks to the Payroll.Web API only through the configured
// local/domain endpoint. Render is intentionally not hard-coded.
//
// Physical Android device:
// BIOMETRIC_API_BASE_URL=http://192.168.1.100:5000/
//
// Android Emulator:
// BIOMETRIC_API_BASE_URL=http://10.0.2.2:5000/
...
dependencies {
    ...
    // SignalR
    //
    // Existing compatibility/realtime path.
    // Endpoint is now configurable and no longer hard-coded to Render.
    // ------------------------------------------------------------
